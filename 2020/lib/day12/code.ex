defmodule Advent2020.Day12 do
  ...
  defp move(
         {vertical_position, horizontal_position, heading},
         <<direction::binary-size(1), rotate_degrees::binary>>
       ) do
  ...
  defp move(
         {ship_vertical, ship_horizontal, waypoint_vertical, waypoint_horizontal},
         <<"N", distance::binary>>
       ) do
    {ship_vertical, ship_horizontal, waypoint_vertical + String.to_integer(distance),
     waypoint_horizontal}
  end
  ...
  defp move(
    ...
    {ship_vertical, ship_horizontal, waypoint_vertical,
     waypoint_horizontal + String.to_integer(distance)}
  end
  ...
  defp move(
    ...
    {new_waypoint_vertical, new_waypoint_horizontal} =
      update_heading(waypoint_vertical, waypoint_horizontal, direction, rotate_degrees)
  ...
  defp update_heading(
    ...
    new_horizontal_heading =
      update_heading(horizontal_heading, rotation_direction, rotation_degrees)

    new_waypoint_vertical =
      cond do
