...
defmodule Day3 do
  defmodule Part1 do
    ...
    def do_the_thing([wire1, wire2] = instruction_list) do
#      IO.inspect(instruction_list)
      wire1steps = []
      wire2steps = []
      start_position = {0, 0}
      IO.puts("MOVE WIRE 1")
